...
public class SwitchExpressions {
    // Traditional switch
    public static int getValueBefore12(String mode) {
        int result;
        switch (mode) {
            case "a":
            case "b":
    ...
    public static int getValueMultipleLabels(String mode) {
        int result;
        switch (mode) {
            case "a", "b":
                result = 1;
    ...
    /*public static int getValueViaBreak(String mode) {
    ...
    // Java 13, switch expression returns a value via yield
    public static int getValueViaYieldAndArrow(String mode) {
        return switch (mode) {
            case "a", "b" -> 1;
            case "c" -> 2;
            case "d", "e", "f" -> {
